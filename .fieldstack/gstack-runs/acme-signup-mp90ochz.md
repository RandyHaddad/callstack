# GStack Run: acme-signup-mp90ochz

Customer: Acme
Contact: Sarah Chen
Repo: /Users/randyhaddad/Desktop/GBrain Hackathon/callstack/demo-app
Issue: The mobile signup page hides the continue button after typing an email.
...
- /plan-eng-review (Engineering manager) [complete]: medium risk; approval recommended; acceptance criteria: Continue button remains visible after entering an email; Signup process can be completed on mobile
- /review (Production reviewer) [complete]: Generated a GStack work order for signup: The mobile signup page hides the continue button after typing an email.
- /qa (QA lead) [complete]: QA plan ready from acceptance criteria: Continue button remains visible after entering an email; Signup process can be completed on mobile
- /ship (Release engineer) [skipped]: Ship is gated on customer/human approval; FieldStack will request APPROVE before deploy.

## Acceptance Criteria
- Continue button remains visible after entering an email
- Signup process can be completed on mobile