# GStack Run: acme-billing-mp911qge

Customer: Acme
Contact: Haris Jalal
Repo: /Users/randyhaddad/Desktop/GBrain Hackathon/callstack/demo-app
Issue: Billing page shows a blank screen after opening invoices.
...
- /plan-eng-review (Engineering manager) [complete]: medium risk; approval recommended; acceptance criteria: Invoices display correctly; No blank screen appears
- /review (Production reviewer) [complete]: Generated a GStack work order for billing: Billing page shows a blank screen after opening invoices.
- /qa (QA lead) [complete]: QA plan ready from acceptance criteria: Invoices display correctly; No blank screen appears
