# GStack Run: acme-signup-mp90v51l

Customer: Acme
Contact: Haris Jalal
Repo: /Users/randyhaddad/Desktop/GBrain Hackathon/callstack/demo-app
Issue: The continue button is hidden after typing an email on the mobile signup page.
...
- /plan-eng-review (Engineering manager) [complete]: medium risk; approval recommended; acceptance criteria: Continue button is visible after entering an email
- /review (Production reviewer) [complete]: Generated a GStack work order for signup: The continue button is hidden after typing an email on the mobile signup page.
- /qa (QA lead) [complete]: QA plan ready from acceptance criteria: Continue button is visible after entering an email
- /ship (Release engineer) [skipped]: Ship is gated on customer/human approval; FieldStack will request APPROVE before deploy.

## Acceptance Criteria
- Continue button is visible after entering an email